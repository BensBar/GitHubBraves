...
- Turnstile can be hidden in production builds with `VITE_HIDE_TURNSTILE_IN_PROD=true`
...
3. Set `VITE_HIDE_TURNSTILE_IN_PROD=true` if you do not want Turnstile shown in production
